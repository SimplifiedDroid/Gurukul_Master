...
import com.example.gurukul_master.databinding.ActivityExampaperDetailBinding
import com.google.firebase.database.*


class ExamPaperDetailActivity : AppCompatActivity() {
    var reference: DatabaseReference? = null
    var databaseReference: DatabaseReference? = null
    private lateinit var binding: ActivityExampaperDetailBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this, R.layout.activity_exampaper_detail)
        val subjects = ArrayList<String>()
        val subjectsArrayList = ArrayList<Subjects>()
        binding.classnameExampaper.text = MyStaticClass.classname.toString()
        databaseReference =
        ...
        databaseReference?.addListenerForSingleValueEvent(object :
            ...
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                val subjectAdapter = DetailSubjectAdapter(
                    this@ExamPaperDetailActivity,
                    subjectsArrayList,
                    "ExamPaper"
                )
                binding.subjectinExampaper.apply {
                    adapter = subjectAdapter
                    layoutManager = LinearLayoutManager(this@ExamPaperDetailActivity)
                }
            }
